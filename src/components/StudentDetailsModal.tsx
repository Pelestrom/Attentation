...
import { Mail, Phone, Send, LineChart } from 'lucide-react';
...
export const StudentDetailsModal: React.FC<StudentDetailsModalProps> = ({ student, onClose }) => {
  const handleSendWarning = () => {
    const subject = `Avertissement - Absences excessives`;
    const body = `Cher(e) ${student.firstName} ${student.lastName},

Nous avons remarqué un nombre important d'absences dans votre dossier :
- Absences justifiées : ${student.justifiedAbsences}h
- Absences non justifiées : ${student.unjustifiedAbsences}h

Nous vous rappelons que l'assiduité est essentielle pour votre réussite académique.
    ...
    >
      <div className="flex flex-col md:flex-row gap-6">
        <div className="md:w-1/3">
          ...
          <div className="mt-6 space-y-4 animate-slideUp">
            ...
            <div className="space-y-2 p-3 bg-gray-50 dark:bg-gray-800 rounded-lg hover:bg-gray-100 
              dark:hover:bg-gray-700 transition-all duration-200 hover-lift">
        ...
        <div className="md:w-2/3 animate-fadeIn">
          <div className="bg-gray-50 dark:bg-gray-800 rounded-lg p-4 hover:bg-gray-100 
